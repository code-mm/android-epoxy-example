...
public class NetworkUtils  {
    ...
    public void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            App.Companion.getINSTANCE().getApplicationContext().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS));
        } else {

            App.Companion.getINSTANCE().getApplicationContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS));
        }
    }
    ...
    public NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) App.Companion.getINSTANCE().getApplicationContext()
